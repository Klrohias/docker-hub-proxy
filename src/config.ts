...
const { DHPROXY_UPSTREAM, DHPROXY_ROOT, DHPROXY_PORT, DHPROXY_DEV } = process.env;
...
const DEVELOPMENT = DHPROXY_DEV;

export { PORT, PROXY_URL, DOCKER_HUB_REGISTRY, SERVER_URL, DOCKER_HUB_AUTH, DOCKER_REGISTRY_SERVICE, DEVELOPMENT };
